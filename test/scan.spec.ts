...
describe('append', () => {
  it('should initially pass the first two elements  and yield the intermediate values when called without seed', () => {
  ...
  it('should initially pass the seed and the first element and yield the intermediate values when called without seed', () => {
